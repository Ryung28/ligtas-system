...
export function useChatV2(roomId: string | null) {
    ...
    const fetchMessages = useCallback(async () => {
        ...
        try {
            ...
            console.error('[Chat-Hook-V2] Fetch Failure:', error)
        } finally {
    ...
    useEffect(() => {
        ...
        const msgChannelName = `coord_v2_${roomId.replace(/-/g, '_')}`
