...
export default function MobileLayout({
    ...
    return (
        <InventoryProvider>
            <div className="fixed inset-0 flex flex-col bg-white overflow-hidden select-none mobile-cage">
                <AdaptiveRoutingSentry />
                {/* Main Interactive Field: The "Steel Cage" scrollable area */}
                <main className="flex-1 overflow-y-auto mb-[calc(64px+env(safe-area-inset-bottom))] bg-gray-50/50 custom-scrollbar">
