...
/**
 * Messenger Window (2026 Kinetic Build)
 ...
 */
export function MessengerWindow({ roomId, title, participant }: MessengerWindowProps) {
    const { messages, isLoadingHistory, presence, currentUserId, sendOptimisticMessage } = useChat(roomId)
