...
/// 🛡️ TACTILE MISSION PROGRESS: Visual Stepper (1 -> 2 -> 3)
class TactileMissionProgress extends StatelessWidget {
  final int currentStep;
  final SentinelColors sentinel;

  const TactileMissionProgress({
    super.key,
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: active 
        ...
        : [
            ...
            BoxShadow(color: const Color(0xFFA2B1C6).withOpacity(0.2), offset: const Offset(2, 2), blurRadius: 4),
          ],
    ),
    child: Center(
      child: Text(
