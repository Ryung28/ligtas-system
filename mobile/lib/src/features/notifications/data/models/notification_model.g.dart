...
void _notificationCollectionSerialize(
  ...
  writer.writeString(offsets[2], object.referenceId);
...
NotificationCollection _notificationCollectionDeserialize(
  ...
  object.referenceId = reader.readStringOrNull(offsets[2]);
...
extension NotificationCollectionByIndex
    on IsarCollection<NotificationCollection> {
  Future<NotificationCollection?> getByRemoteId(String remoteId) {
    return getByIndex(r'remoteId', [remoteId]);
  }

  NotificationCollection? getByRemoteIdSync(String remoteId) {
  ...
  Future<List<NotificationCollection?>> getAllByRemoteId(
      List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'remoteId', values);
  }

  List<NotificationCollection?> getAllByRemoteIdSync(
      List<String> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByRemoteId(NotificationCollection object) {
    return putByIndex(r'remoteId', object);
  }

  Id putByRemoteIdSync(NotificationCollection object, {bool saveLinks = true}) {
    return putByIndexSync(r'remoteId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRemoteId(List<NotificationCollection> objects) {
    return putAllByIndex(r'remoteId', objects);
  }

  List<Id> putAllByRemoteIdSync(List<NotificationCollection> objects,
      {bool saveLinks = true}) {
