...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserModel user) pendingApproval,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserModel user)? pendingApproval,
...
class _$PendingApprovalImpl implements PendingApproval {
  const _$PendingApprovalImpl(this.user);
...
abstract class PendingApproval implements AuthState {
  const factory PendingApproval(final UserModel user) = _$PendingApprovalImpl;
